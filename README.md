...
In conclusion, credit-risk is a difficult thing to predict, when working with balanced accuracy, even for advanced machine learning algorithms. The highest compared accuracy between 0 and 1 and is closest to 1 shows Easy Ensemble AdaBoost Classifier is the best model to choose with its .93 balanced accuracy. The other models were lower than .80 balanced accuracy. The precision for all models were similar and within an appropriate range. The recall score also needs to fall within 0 and 1, with numbers closer to 1 being the better model. The Easy Ensemble AdaBoost Classifier had the highest recall score, making it the final best machine learning model to choose for further credit card analysis.
